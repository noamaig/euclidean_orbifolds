...
%input - vector of differentials, sorted (a_i,b_i,c_i,d_i,a_i+1,b_i+1... etc.), vector of areas
%output - B which is the solution of the problem: min_B LSCM(B*As*areas) s.t. ||B||=1
